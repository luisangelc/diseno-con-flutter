    ...
    return Table(
      children: [
        TableRow(children: [
          ...
          _crearBotonRedondeado(
              Colors.purpleAccent, Icons.directions_bus, 'Bus', context),
        ]),
        TableRow(children: [
          _crearBotonRedondeado(Colors.pinkAccent, Icons.shop, 'Buy', context),
          _crearBotonRedondeado(
              Colors.orange, Icons.insert_drive_file, 'File', context),
        ]),
        TableRow(children: [
          _crearBotonRedondeado(
              Colors.blueAccent, Icons.movie_filter, 'Entertaiment', context),
          _crearBotonRedondeado(Colors.green, Icons.cloud, 'Grocery', context),
        ]),
        TableRow(children: [
          _crearBotonRedondeado(
              Colors.red, Icons.collections, 'Photos', context),
          _crearBotonRedondeado(
              Colors.teal, Icons.help_outline, 'General', context),
        ]),
      ],
    );
  }
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              CircleAvatar(
                ...
                radius: 35.0,
                child: IconButton(
                  icon: Icon(icon, size: 30.0, color: color),
                  tooltip: 'Siguiente',
                  onPressed: () {
